...
// Costumers class
require_once BASE_PATH . '/lib/Costumers/bookings.php';
...
$db = getDbInstance();
$select = array('id','name','email','phone','property_id','amount','booked_at');
...
if ($search_string) {
	...
	$db->orwhere('property_id', '%' . $search_string . '%', 'like');
	$db->orwhere('booked_at', '%' . $search_string . '%', 'like');
}
...
$rows = $db->arraybuilder()->paginate('bookings', $page, $select);
    ...
    <table class="table table-striped table-bordered table-condensed">
        ...
        <tbody>
            ...
            <tr><?php $ayaz = $row['id']; ?>
                ...
                <td><?php echo xss_clean($row['property_id']); ?></td>
                <td><?php echo xss_clean($row['amount']); ?></td>
                <td><?php echo xss_clean($row['booked_at']); ?></td>
            </tr>
            <?php endforeach;?>
        </tbody>
    </table>
    <div class="text-center">
    <?php echo paginationLinks($page, $total_pages, 'bookings.php'); ?>
    </div>
</div>
